...
#ifdef __STM32F2xx_H
    Init_Port_Mode(GP_PP, PB, 7); /* PB7: 	LCD_RES */
    Init_Port_Mode(AF_PP, PB, 3); /* PB3: 	LCD_SCL */
    Init_Port_AF_Mode(AF5, PB, 3);
    Init_Port_Mode(GP_PP, PB, 4); /* PB4: 	LCD_A0 */
    Init_Port_Mode(AF_PP, PB, 5); /* PB5: 	LCD_SI */
    Init_Port_AF_Mode(AF5, PB, 5);
    Init_Port_Mode(GP_PP, PB, 6); /* PB6: 	LCD_CSI */
